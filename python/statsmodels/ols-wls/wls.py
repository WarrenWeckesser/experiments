...
# (Challenge: rewrite the above code to compute cluster_stats without a for
# loop.)
...
plt.plot(xx, var_est(xx), 'b',
         label="Estimated variance (quadratic fit)")
...
plt.xlabel(r'$\sqrt{w} y$', fontsize=18)
plt.ylabel('e')
plt.grid()
plt.subplot(2, 1, 2)
